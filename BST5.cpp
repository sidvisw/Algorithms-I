...
//child swapping function
Node*childSwap(Node*root){
    if(!root) return root;
    root->left=childSwap(root->left);
    root->right=childSwap(root->right);
...
main()
{
    ...
    cout<<"Traversals before swapping..."<<endl;
    ...
    Postorder(root);
    root=childSwap(root);
    cout<<"Traversals after swapping..."<<endl;
    cout<<"Preorder traversal..."<<endl;
    Preorder(root);
    cout<<"Inorder traversal..."<<endl;
    Inorder(root);
